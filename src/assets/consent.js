...
(function () {
	...
	function addSettingsLink() {
		...
		btn.style.cssText = 'color:inherit;text-decoration:underline;text-decoration-color:#7AAFFF;text-underline-offset:3px;cursor:pointer;background:none;border:0;padding:0;font:inherit';
