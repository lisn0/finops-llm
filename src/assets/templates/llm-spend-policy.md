...
>
> Template published by FinOps LLM (https://finopsllm.com). Use it freely, no attribution required.
...
*Adapted from the policy skeleton FinOps LLM uses during cost audits. If you want
this filled in against your actual invoices, the audit is free:
https://finopsllm.com/book*
